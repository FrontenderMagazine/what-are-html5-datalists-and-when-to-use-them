...
![Поддержка \<datalist\> для типов input в формах][Рисунок5]
...
![Стандартный выпадающий список выбора страны][Рисунок6]
...
![Использование списка вариантов \<datalist\> для создания формы ввода страны][Рисунок7]
