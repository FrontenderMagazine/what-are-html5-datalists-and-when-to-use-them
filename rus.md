...
Всем интернет-пользователям знакома такая функция как автодополнение. Когда вы 
...
добавлять функцию автодополнения без использования JavaScript. 
...
вариантов, чтобы найти нужный. В этом случае функция автодополнения более удобна, 
...
![Рисунок10][Список вариантов названий стран с использованием виджета автодополнения на основе jQuery в качестве полифила]
...
Следующий пример демонстрирует как можно настроить функцию автодополнения, 
