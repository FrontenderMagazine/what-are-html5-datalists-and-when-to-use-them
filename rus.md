...
валидных значений, которые пользователь может ввести, строго ограничено. В таком 
...
Этот список неудобен для пользователей, так как им необходимо пролистать сотни 
вариантов, чтобы найти нужный. В этом случае функция автодополнения удобнее, 
